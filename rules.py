...
def total_borrowing(data: dict, financial_index):
    ...
    try:
        financial = data["financials"][financial_index]
        long_term_borrowing = financial["bs"]["lineItems"]["long_term_borrowing"]
        short_term_borrowing = financial["bs"]["lineItems"]["short_term_borrowing"]
        ...
        if total_rev is not None:
            return total_borrowings / total_rev
        return None
    except (IndexError, KeyError):
        return None
...
def iscr(data: dict, financial_index):
    ...
    try:
        financial = data["financials"][financial_index]
        pbit = financial["pnl"]["lineItems"]["profit_before_interest_and_tax"]
        depreciation = financial["pnl"]["lineItems"]["depreciation"]
        interest_expenses = financial["pnl"]["lineItems"]["interest_expenses"]
